    ...
    <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="content-block">
                ...
                <?= form_open('level-add', 'class="form-vertical"') ?>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="userview" id="userview" value="Y" <?php if (set_value('userview') == 'Y') echo 'checked' ?> />
                                        <label class="form-check-label" for="userview">
                                            Yes
                                        </label>
                                        <input class="form-check-input" type="radio" name="userview" id="userview" value="N" checked <?php if (set_value('userview') == 'N') echo 'checked' ?> />
                                        <label class="form-check-label" for="userview">
                                            No
                                        </label>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="userinsert" id="userinsert" value="Y" <?php if (set_value('userinsert') == 'Y') echo 'checked' ?> />
                                        <label class="form-check-label" for="userinsert">
                                            Yes
                                        </label>
                                        <input class="form-check-input" type="radio" name="userinsert" id="userinsert" value="N" checked <?php if (set_value('userinsert') == 'N') echo 'checked' ?> />
                                        <label class="form-check-label" for="userinsert">
                                            No
                                        </label>
                                    </div>
